  ...
  <div class="shadow border w-64 mr-10 z-30 h-[190px]">
    ...
    <div class="p-5 flex justify-between relative cursor-pointer border-b">
      ...
      <div 
        ...
        <input text="text" class="border p-1 rounded" v-model="city"/>
        <button 
    ...
    <div class="p-5 flex justify-between relative cursor-pointer border-b">
      ...
      <div class="absolute border shadow left-56 top-1 p-5 -m-1 bg-white" v-if="modal.price">
        ...
        <button class="bg-blue-400 w-full mt-3 rounded text-white" @click="onChangePrice(price)">Apply</button>
      </div>
    </div>
    <!---PRICE END-->
  </div>
